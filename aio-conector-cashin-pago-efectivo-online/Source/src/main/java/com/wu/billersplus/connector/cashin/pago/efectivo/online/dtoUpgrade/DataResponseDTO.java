...
public class DataResponseDTO {
    ...
    public List<DocumentDetailDTO> getDocumentsDetail() { return documentsDetail; }
    public void setDocumentsDetail(List<DocumentDetailDTO> documentsDetail) { this.documentsDetail = documentsDetail; }
